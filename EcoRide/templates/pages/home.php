...
<section id="homePage">
  <div class="hero relative isolate overflow-hidden py-10 sm:py-24 mt-5">
    ...
    <div class="hidden sm:absolute sm:-top-10 sm:right-1/2 sm:-z-10 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl"
      aria-hidden="true">
      <div class="aspect-1097/845 w-274.25 bg-linear-to-tr from-[#6E6E6E] to-[#F7F7F7] opacity-20"
  ...
  <!-- form -->
  <div class="form w-3/4 mx-auto p-5 mt-3 md:mt-0 bg-white rounded-md shadow-md">
    <form id="formHome" method="post">
      <div class="block lg:flex gap-6 justify-around items-center pb-5">
        <div>
        ...
        <div>
          ...
          <input type="date" id="departureDateHome"
            class="block w-full px-4 py-2 mt-2 border border-gray-200 rounded-md focus:ring-emerald-500 focus:ring-opacity-10 focus:outline-none focus:ring"
            name="departureDateHome">
        ...
        <div class="flex items-center">
          <button type="submit"
            class="btnSearch mt-2 lg:mt-0 item-center px-5 py-2 leading-5 text-white transition-colors duration-300 transform rounded-md focus:outline-none">Rechercher</button>
        </div>
      </div>
      ...
      <div class="w-full p-5 bg-green-600 md:flex md:items-center rounded-2xl md:bg-transparent md:p-0 lg:px-12 md:justify-evenly">
        ...
        <div class="mt-2 sm:mx-6">
          <p class="text-xs text-white md:text-xl"><strong>EcoRide</strong> est une entreprise française
            ...
            Notre mission est
            de simplifier la mise en relation entre conducteurs et passagers pour des <strong>trajets plus
              écologiques</strong>. Avec
            EcoRide, voyagez de manière écoresponsable et participez à un avenir plus vert.
            <strong>Drive Green Together!</strong>
          </p>
        </div>
      </div>
    </div>
