<section id="useCarsPage" class="mt-5">
            ...
            <div class="-m-1.5 overflow-x-auto">
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div class="border border-gray-200 rounded-xl shadow-2xs overflow-hidden">
                            ...
                            <div>
                                <div class="inline-flex gap-x-2">
                                    <button type="button" id="btnOpenModal"
                                        ...
                                        aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-modal-signup"
                                ...
                                <?php foreach ($cars as $car) {?>
                                    <tr>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <form method="post">
                                                    <input type="hidden" name="idCarDelete"
                                                        value="<?php echo $car->getId(); ?>">
                                                    <input type="hidden" name="token_csrf"
                                                        value="<?php echo htmlspecialchars($token); ?>">
                                                    <button class="text-sm" name="submitDeleteCar" value="submitDeleteCar"
                        ...
                        <div
                            class="bg-gray-50/60 px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-gray-300">
                            <div>
    ...
    <!-- Modal -->
    <div id="addCarModal"
        class="hidden bg-gray-500/50 size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto" role="dialog"
        tabindex="-1" aria-labelledby="hs-modal-signup-label">
        <div id="addCaroverlay"
                    ...
                    <form id="addCarForm" method="post">
                        <div class="grid gap-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="nbPlate" name="nbPlate"
                                    class="block w-full px-5 py-3 mt-2 border border-gray-200 rounded-lg focus:border-emerald-500 focus:outline-none"
                                    aria-describedby="numplateerror" placeholder="XX-000-XX">
                                <p class="hidden text-xs text-red-600 mt-2" id="numplateError"></p>
                            </div>

                            <div>
                                <label for="dateNbPlate" class="block text-sm mb-2">Date de la première
                                    immatriculation</label>
                                <input type="date" id="dateNbPlate" name="dateNbPlate"
                                    class="block w-full px-5 py-3 mt-2 border border-gray-200 rounded-lg focus:border-emerald-500 focus:outline-none"
                                    aria-describedby="datenumplateerror">
                            ...
                            <div>
                                ...
                                <input type="text" id="colorCreate" name="colorCreate"
                                    class="block w-full px-5 py-3 mt-2 border border-gray-200 rounded-lg focus:border-emerald-500 focus:outline-none"
                                    aria-describedby="colorerror" placeholder="Blanc">
                            ...
                            <div class="flex justify-around">
                                <button type="button" id="closeModal"
                                    class="btn py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border text-white">Annuler</button>
                                <button id="btnAddCar" type="submit" name="newCar" value="newCar"
                                    class="btn py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg text-white">Ajouter
                                    la voiture</button>
                            </div>
                        </div>
                    </form>
