    ...
    <div class="container px-6 py-10 mx-auto">
        <div class="flex justify-between">
            ...
            <div class="flex justify-between  gap-6">
                ...
                <h2 class="text-2xl font-semibold text-gray-800  lg:text-3xl"><?php echo $details->getDepartureDate() ?>
                </h2>
            </div>
        ...
        <div class="flex justify-between mt-6 gap-6">
            ...
            <div class="p-6 space-y-3 border-2 border-blue-400 rounded-xl w-2/3">
            ...
            <div class="p-6 space-y-3 border-2 border-emerald-600 rounded-xl w-1/3">
                    ...
                    <div class="flex w-1/2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" xml:space="preserve"
                            ...
                            <path
                                ...
                                style="fill:none;stroke:#222a33;stroke-width:2px" />
                            <path d="m44.75 46.748 2.5 2 4-3.5" style="fill:none;stroke:#222a33;stroke-width:2px" />
                        </svg>
