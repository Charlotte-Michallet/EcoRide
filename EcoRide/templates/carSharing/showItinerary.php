    ...
    <?php if (isset($_SESSION["role"]) && $_SESSION["role"] === 3) {?>
        ...
        <div class="max-w-3xl flex flex-col mx-auto size-full">
            ...
            <div class="text-center py-10 px-4 sm:px-6 lg:px-8">
                <h1 class="block text-3xl font-bold text-gray-800 ">Veuillez changer de role pour acceder au fonctionnalité
                </h1>
    ...
    <?php } else {?>
            ...
            <div class="flex flex-col">
                <div class="w-full flex items-center gap-6 justify-around">
                    <div>
                        ...
                        <input type="text" id="departureItineray"
                            ...
                            name="departureItineray" placeholder="Ex: Paris">
                    ...
                    <div>
                        ...
                        <input type="text" id="arrivalItineray"
                            class="block w-full px-4 py-2 mt-2 border border-gray-200 rounded-md focus:ring-emerald-500 focus:ring-opacity-10 focus:outline-none focus:ring"
                            name="arrivalItineray" placeholder="Ex: Lille">
                    ...
                    <div>
                        ...
                        <input type="date" id="departureDateItineray"
                            class="block w-full px-4 py-2 mt-2 border border-gray-200 rounded-md focus:ring-emerald-500 focus:ring-opacity-10 focus:outline-none focus:ring"
                            name="departureDateItineray">
                        <p class="hidden text-xs text-red-600 mt-2" id="dateError"></p>
                    </div>

                    <div>
                        <label for="numPassengers">Nombre de passagers</label>
                        <input type="number" id="numPassengersItineray"
                            class="block w-full px-4 py-2 mt-2 border border-gray-200 rounded-md focus:ring-emerald-500 focus:ring-opacity-10 focus:outline-none focus:ring"
                            name="numPassengersItineray" placeholder="3" min="1">
                        <p class="hidden text-xs text-red-600 mt-2" id="numPlacesError"></p>

                    </div>

                    <input type="hidden" name="tokenItineray" id="tokenItineray"
                        value="<?php echo htmlspecialchars($token) ?>">


                    <div>
                        <button type="submit" id="submitItinery"
        ...
        <div class="max-w-[85rem] px-4 p-5 sm:px-6 lg:px-8 mx-auto">
            ...
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                <h1 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Soyez ecologique, Econimisez,
                    Partagez, Voyagez</h1>
