...
<footer class="bg-gray-100">
  <div class="relative mx-auto max-w-screen-xl px-4 py-2 sm:px-6 lg:px-8 lg:pt-5">
    <div class="absolute -end-20 -top-5">
      <a
        class="btn inline-block rounded-full p-1 text-white shadow-sm transition sm:p-2 lg:p-4"
        href="#">
          <svg
    ...
    <div class="lg:flex lg:items-end lg:justify-between pb-5 items-center">

        <div>
          <img  class="h-20 w-35 object-contain" src="assets/img/logo/logo.png" alt="">
        </div>

        <p class="my-auto mx-auto max-w-md text-center text-gray-500 lg:text-left">
         Copyright &copy; 2025. All rights reserved.
        </p>

        <ul
        class="flex flex-wrap justify-center gap-6 md:gap-8 lg:mt-0 lg:justify-end lg:gap-12"
      >
        <li>
