            ...
            <div class="w-full">
                ...
                <form class="grid grid-cols-1 mt-1 gap-6 md:grid-cols-2" method="post">
                    ...
                    <div>
                        ...
                        <input type="email" id="emailRegister" class="block w-full px-5 py-3 mt-2 border border-gray-200 rounded-lg focus:border-emerald-500 focus:outline-none" name="emailRegister" placeholder="nom.prenom@gmail.com" autocomplete="email" />
