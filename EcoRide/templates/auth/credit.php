<section id="credit" class="mt-5">
    ...
    <div class="bg-white">
        <div class="container px-6 py-8 mx-auto">
            <h2 class="text-3xl font-semibold text-center capitalize">Crédits</h2>

            <p class="text-4xl mx-auto mt-4 text-center xl:mt-6">
                Vous pouvez recharger vos crédits
            </p>
            ...
            <div class="grid grid-cols-1 gap-8 mt-6 xl:mt-12 xl:gap-12 md:grid-cols-2 lg:grid-cols-3">
                <div class="flex items-center justify-center w-full p-8 space-y-8 text-center border border-gray-200 rounded-lg">
                    <div>
                        <p class="font-medium text-gray-700 uppercase ">Vos crédits</p>
                ...
                <div class="w-full p-8 space-y-8 text-center border border-gray-200 rounded-lg">
                    ...
                    <form method="post">
                        ...
                        <input type="number" id="credits" class="text-4xl font-semibold block w-full px-5 py-3 mt-2 border border-gray-200 rounded-lg focus:border-emerald-500 focus:outline-none" placeholder="50 crédits" min="1">
