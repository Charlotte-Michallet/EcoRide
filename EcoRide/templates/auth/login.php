<section id="loginPage" class="login mt-5">
    <div class="m-13 w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md ">
        <div class="px-6 py-4">
            ...
            <h3 class="mt-3 text-xl font-medium text-center">Se connecter</h3>
            ...
            <form method="post">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input type="password" id="pwdLogin"
                            class="block w-full px-5 py-3 mt-2 border border-gray-200 rounded-lg focus:border-emerald-500 focus:outline-none"
                            name="pwdLogin" placeholder="8+ caractères (majuscule et chiffre...)" />
                ...
                <div class="flex items-center justify-end mt-4">
                    <button type="submit"
                        class="btn px-6 py-2 text-sm text-white font-medium tracking-wide capitalize transition-colors duration-300 transform rounded-lg">
                        Se connecter </button>
                </div>
            </form>
        </div>
