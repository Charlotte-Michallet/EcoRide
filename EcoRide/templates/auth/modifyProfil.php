<section id="modifyProfilPage" class="mt-5">
    ...
    <div class="max-w-[85rem] px-4 py-5 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="lg:grid lg:grid-cols-12 lg:gap-16 lgjustify-between">
            <div class="container lg:col-span-5 min-h-screen px-6 mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 mt-1 gap-6">
                    <?php if ($_SESSION["role"] !== 1 && $_SESSION["role"] !== 2) {?>
                        ...
                        <form method="post" id="formRoles" class="col-span-4">
                            <fieldset class="flex flex-wrap justify-between">
                                ...
                                <div>
                                    <label for="driverAndPassenger"
                                        class="flex mb-2 md:mb-0 items-center justify-between gap-4 rounded border border-gray-300 p-3 text-sm font-medium shadow-sm transition-colors hover:bg-gray-50 has-checked:ring-1 has-checked:ring-emerald-500">
                                        <p class="text-gray-700">Conducteur et passager</p>
                                        <input type="radio" name="userRoles" value="driverAndPassenger"
                                            id="driverAndPassenger" class="sr-only" />
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label for="driver"
                                        ...
                                        <p>Conducteur</p>
                                        <input type="radio" name="userRoles" value="driver" id="driver" class="sr-only" />
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label for="passenger"
                                        class="flex items-center justify-between gap-4 rounded border border-gray-300 p-3 text-sm font-medium shadow-sm transition-colors hover:bg-gray-50 has-checked:ring-1 has-checked:ring-emerald-500">
                                        <p>Passager</p>
                                        <input type="radio" name="userRoles" value="passenger" id="passenger"
                                            class="sr-only" />
                                    </label>
                                </div>
                            </fieldset>
                            ...
                            <button type="submit"
                                class="btn mt-3 flex items-center justify-between px-6 py-3 text-sm tracking-wide text-white transition-colors duration-300 transform rounded-lg">Modifier
                                le rôle</button>
                        </form>
                    <?php }?>

                    <!-- Username -->
                    <form method="post" id="formUsername" class="col-span-4 xl:col-span-2 flex">
                        <div>
                            ...
                            <button type="submit"
                                class="btn mt-3 flex items-center justify-between px-6 py-3 text-sm text-white transition-colors duration-300 transform rounded-lg">Modifier
                                le nom d’utilisateurr</button>
                        </div>
                    </form>

                    <!-- Email -->
                    <form method="post" id="formEmail" class="col-span-4 xl:col-span-2 flex">
                        <div>
                    ...
                    <form method="post" id="formPhoto" class="col-span-4 flex">
                        ...
                        <div>
                            ...
                            <button type="submit"
                                class="btn mt-3 flex items-center justify-between w-full px-6 py-3 text-sm tracking-wide text-white transition-colors duration-300 transform rounded-lg md:col-start-1">Ajouter
                                une photo</button>
                        </div>
                    </form>
                    ...
                    <form method="post" id="formpassword" class="col-span-4">
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" id="passwordModif"
                                    ...
                                    name="passwordModif" placeholder="8+ caractères, une majuscule, un chiffre" />
                        ...
                        <div>
                            <label for="ConfPwd" class="block mb-2 mt-2 text-sm">Confirmation de mot de passe</label>
                            <div class="relative">
                        ...
                        <div class="col-span-2 flex">
                            ...
                            <button type="submit"
                                class="btn mt-3 flex items-center justify-between px-6 py-3 text-sm tracking-wide text-white transition-colors duration-300 transform rounded-lg md:col-start-1">Modifier
            ...
            <!-- preference -->
            <div class="container col-span-12 lg:col-span-6 lg:min-h-screen px-6 mx-auto ">
                <h2 class="text-2xl font-semibold mt-5 lg:mt-0">Ajouter ou modifier mes préférences</h2>
                <div class="mt-6">
                    <h3 class="text-gray-800">Sélectionnez vos préférences</h3>
                </div>


                <div class="grid-cols-12 lg:grid-cols-6">
                    ...
                    <form class="grid grid-cols-1 mt-1 gap-6 md:grid-cols-2 mt-4" method="post"
                        id="formotherPreferences">
                        <div>
                        ...
                        <button type="submit"
                            class="btn mb-5 md:mb-0 flex items-center justify-between w-full px-6 py-3 text-sm tracking-wide text-white transition-colors duration-300 transform rounded-lg md:col-start-1">Valider
