            ...
            <div class="-m-1.5 overflow-x-auto">
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div class="bg-white border border-gray-200 rounded-xl shadow-2xs overflow-hidden">
                        <!-- Header -->
                        <div
                            class="px-6 py-4 grid gap-3 md:flex md:justify-start md:items-center border-b border-gray-200">
                            <div>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <?php foreach ($users as $user) {?>
                                    <tr>
                                            ...
                                            <div class="px-6 py-3">
                                                <div class="flex items-center gap-x-2">
                                                    <img class="inline-block w-10 h-9 rounded-full"
                                                        src="<?php echo $user->getPhotoUrl(); ?>" alt="Avatar">
                                                    <div class="grow">
                                                        <span
                                                            class="text-sm text-gray-600"><?php echo $user->getUsername(); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="text-sm text-gray-600"><?php echo $user->getRole(); ?></span>
                                            </div>
                                        </td>
                        ...
                        <div
                            ...
                            <div>
                                <p class="text-sm text-gray-600">
                                    <span class="font-semibold text-gray-800"><?php echo $totalUsers ?> </span>
                                    utilisateurs
                                </p>
                            </div>
